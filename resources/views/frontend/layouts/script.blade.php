...
<script src="{{ asset('assets/frontend/js/scroll-up-bar.min.js') }}"></script>
...
<script src="{{ asset('assets/frontend/js/jquery-nao-calendar.js') }}"></script>
<script src="{{ asset('assets/frontend/js/jquery-pseudo-ripple.js') }}"></script>
...
<script src="{{ asset('assets/frontend/js/revolution/revolution-init2.js') }}"></script>
